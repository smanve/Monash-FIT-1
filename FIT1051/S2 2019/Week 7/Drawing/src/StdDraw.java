...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    public static JMenu menuMore = null; //SH
    ...
    private static void init() {
        ...
        frame.setLocationRelativeTo(null); //shuxford
    ...
    private static JMenuBar createMenuBar() {
        ...
        menuMore = new JMenu("More"); //SH
        menuBar.add(menuMore); //SH
    ...
    public static JMenu getMenuMoreRef(){
        return menuMore;
    }
