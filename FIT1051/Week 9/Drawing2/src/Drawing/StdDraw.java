...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static void init() {
        ...
        frame.setLocationRelativeTo(null); //SH
        frame.setVisible(true);
    }

    //SH
    private static DoingIt d;
    public static void getDoingItInstance(DoingIt inst){
        d = inst;
    }
    ...
    private static JMenuBar createMenuBar() {
        ...
        JMenu menu2 = new JMenu("Do Stuff");
        menuBar.add(menu2);

        JMenuItem menuItem21 = new JMenuItem("Random rectangles");
        menuItem21.addActionListener(std);
        menuItem21.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_R,
                Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));

        JMenuItem menuItem22 = new JMenuItem("Uniform rectangles");
        menuItem22.addActionListener(std);
        menuItem22.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_U,
                Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));

        JMenuItem menuItem23 = new JMenuItem("Fade away");
        menuItem23.addActionListener(std);
        menuItem23.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F,
                Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));

        JMenuItem menuItem24 = new JMenuItem("Concentric");
        menuItem24.addActionListener(std);
        menuItem24.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_C,
                Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));


        JMenuItem menuItem25 = new JMenuItem("Your rectangles operation");
        menuItem25.addActionListener(std);
        menuItem25.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Y,
                Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));
    ...
    ***************************************************************************/
    ...
    public void actionPerformed(ActionEvent e) {
        String menuItemCommandString = e.getActionCommand(); //SH
        if(menuItemCommandString.equals("Save...")) {//SH
        ...
        else if (menuItemCommandString.equals("Random rectangles")){ //SH
            //System.out.println("Random rectangles");
            d.makeRandomRectangles();
        }
        else if (menuItemCommandString.equals("Uniform rectangles")){ //SH
            //System.out.println("Unifrom rectangles");
            d.makeUniformRectangles();
        }
        else if (menuItemCommandString.equals("Fade away")){ //SH
            //System.out.println("Fade away");
            d.fadeAway();
        }
        else if (menuItemCommandString.equals("Concentric")){ //SH
            //System.out.println("Concentric");
            d.concentric();

        }
        else if (menuItemCommandString.equals("Your rectangles operation")){ //SH
            //System.out.println("Your rectangles operation");
            d.yourOperation();
        }
    }
